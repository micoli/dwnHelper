...
$app->register(new \Propel\Silex\PropelServiceProvider(), array(
	'propel.model_path'	=> $gblCfg['propel.model_path'],
	'propel.config_file'=> $gblCfg['propel.config_file']
));
Propel::setLogger($app['monolog']);
*/
$app->register(new TwigServiceProvider(), array(
	'twig.class_path'	=> $gblCfg['twig.class_path'],
	'twig.path'			=> $gblCfg['twig.path'],
	'twig.options'		=> array(
		'charset'			=> 'utf-8',
